class ZCL_Z_ZZD530_GWSAMPLE_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_ZZD530_GWSAMPLE_MPC=====CP' ##NO_TEXT.
...
CLASS ZCL_Z_ZZD530_GWSAMPLE_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_ZZD530_GWSAMPLE_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_ZZD530_GWSAMPLE_MPC=>TS_FLIGHT' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_ZZD530_GWSAMPLE_MPC=>TS_PRODUCT' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_ZZD530_GWSAMPLE_MPC=>TS_SUPPLIER' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20181114222714'.                  "#EC NOTEXT
