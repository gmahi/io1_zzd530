class ZCL_Z_D530_PO_MPC definition
  public
...
TT_POITEM type standard table of TS_POITEM .
  types:
     TS_EKKOEKPO type ZZD530_EKKOEXPO .
  types:
TT_EKKOEKPO type standard table of TS_EKKOEKPO .

  constants GC_EKKOEKPO type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ekkoekpo' ##NO_TEXT.
...
CLASS ZCL_Z_D530_PO_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_D530_PO_SRV' ).
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'HeadToItemsNav' "#EC NOTEXT
                                                              iv_abap_fieldname = 'HEADTOITEMSNAV' "#EC NOTEXT
                                                              iv_association_name = 'HeadToItemsAss' ). "#EC NOTEXT
  endmethod.


  method DEFINE_EKKOEKPO.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ekkoekpo' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZZD530_EKKOEXPO'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ekkoekpoSet' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_true ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Ktmng' iv_abap_fieldname = 'KTMNG' ). "#EC NOTEXT
lo_property->set_type_edm_decimal( ).
lo_property->set_precison( iv_precision = 3 ). "#EC NOTEXT
lo_property->set_maxlength( iv_max_length = 13 ). "#EC NOTEXT
lo_property->set_creatable( abap_true ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20181118224855'.                  "#EC NOTEXT
